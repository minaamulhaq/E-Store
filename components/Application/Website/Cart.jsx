        ...
        <Sheet open={Open} onOpenChange={setOpen}>
            ...
            <SheetContent className="gap-0">
                ...
                <div className='h-[calc(100vh-40px)]'>
                    <div className='h-[calc(100%-130px)] overflow-auto pb-2' >
                    ...
                    <div className="h-28 border-t pt-2 px-2">
                        ...
                        <div className='flex mt-1 mb-2'>
                            <Button className="w-[180px]" asChild variant={"secondary"} onClick={() => { setOpen(!Open) }}>
                                <Link href="/cart">View Cart</Link>
                            </Button>
                            <Button className="w-[180px] ml-2" asChild onClick={() => { setOpen(!Open) }}>
